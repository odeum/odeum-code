...
- [4. ODEUM CodeJS App Components Reference Guide](#4-odeum-codejs-app-components-reference-guide)
    - [4.1. Create-React-App (CRA)](#41-create-react-app-cra)
        - [4.1.1. Setup instructions](#411-setup-instructions)
- [5. Experiments (initial developer experiments)](#5-experiments-initial-developer-experiments)
    ...
    - [5.4. Codesplitting / PRPL (former experiment 1)](#54-codesplitting--prpl-former-experiment-1)
    - [5.5. Redux](#55-redux)
    - [5.6. Framework (former experiment 3.1)](#56-framework-former-experiment-31)
    - [5.7. Demo App to Connect to the ODEUM CodeJS framework](#57-demo-app-to-connect-to-the-odeum-codejs-framework)
    - [5.8. Login](#58-login)
    - [5.9. REST and components API documentation platform/style](#59-rest-and-components-api-documentation-platformstyle)
    - [5.10. REST API implementation experiments](#510-rest-api-implementation-experiments)
    - [5.11. IAM - Identity and Access Management](#511-iam---identity-and-access-management)
    - [5.12. ODEUM CodeJS experiments site in production](#512-odeum-codejs-experiments-site-in-production)
    - [5.13. Deployment](#513-deployment)
    - [5.14. Naming Conventions](#514-naming-conventions)
    - [5.15. JavaScript Style Guide](#515-javascript-style-guide)
    - [5.16. Debugging with Chrome in VS Code](#516-debugging-with-chrome-in-vs-code)
    - [5.17. Test setup scenarios](#517-test-setup-scenarios)
    - [5.18. Themes in ODEUM CodeJS (former experiment 16)](#518-themes-in-odeum-codejs-former-experiment-16)
    - [5.19. Help Server (Help Items)](#519-help-server-help-items)
    - [5.20. Menu](#520-menu)
    - [5.21. Responsiveness](#521-responsiveness)
    - [5.22. Search Server](#522-search-server)
    - [5.23. Redux Forms](#523-redux-forms)
    - [5.24. Filename Refactoring (VSCode Extension)](#524-filename-refactoring-vscode-extension)
- [6. Apps](#6-apps)
...
- [10. JavaScript and React Style Guide](#10-javascript-and-react-style-guide)
    - [10.1. Inspiration](#101-inspiration)
    - [10.2. PropTypes](#102-proptypes)
    - [10.3. Components](#103-components)
        - [10.3.2. Stateless components (presentational components)](#1032-stateless-components-presentational-components)
        - [10.3.3. Stateful components (container components)](#1033-stateful-components-container-components)
...
## 5.4. Codesplitting / PRPL (former experiment 1)
...
## 5.6. Framework (former experiment 3.1)
...
## 5.7. Demo App to Connect to the ODEUM CodeJS framework
...
## 5.9. REST and components API documentation platform/style
- Research and propose API documentation platform and style

## 5.10. REST API implementation experiments
- All available forces

## 5.11. IAM - Identity and Access Management
...
## 5.12. ODEUM CodeJS experiments site in production
...
## 5.24. Filename Refactoring (VSCode Extension)
...
### 10.3.2. Stateless components (presentational components)
...
### 10.3.3. Stateful components (container components)
