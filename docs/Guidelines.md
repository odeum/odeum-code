...
- [5. Experiments (initial developer experiments)](#5-experiments-initial-developer-experiments)
	...
	- [5.3. Experiments List](#53-experiments-list)
		...
		- [5.3.7. Datagrid/Datatables](#537-datagriddatatables)
		- [5.3.8. React Drag and Drop (react-dnd)](#538-react-drag-and-drop-react-dnd)
		- [5.3.9. Page Not Found (404) module](#539-page-not-found-404-module)
		- [5.3.10. WYSIWYG editor (draftjs)](#5310-wysiwyg-editor-draftjs)
		- [5.3.11. Skeleton Loading](#5311-skeleton-loading)
		- [5.3.12. Color picker](#5312-color-picker)
		...
		- [5.3.17. Full-screen presentations (ODEUM Sales Manager/ODEUM Report)](#5317-full-screen-presentations-odeum-sales-managerodeum-report)
		- [5.3.18. ODEUM Telemetry Services](#5318-odeum-telemetry-services)
		- [5.3.19. Login](#5319-login)
		- [5.3.20. REST and components API documentation platform/style](#5320-rest-and-components-api-documentation-platformstyle)
		- [5.3.21. REST API implementation experiments](#5321-rest-api-implementation-experiments)
		- [5.3.22. IAM - Identity and Access Management](#5322-iam---identity-and-access-management)
		- [5.3.23. App ID + Token Creator](#5323-app-id--token-creator)
		- [5.3.24. ODEUM Code website](#5324-odeum-code-website)
		- [5.3.25. Deployment](#5325-deployment)
...
Initially we pull and commit work from/to 3 branches:
...
* Core Software Developemt Team
	* [Andrei Tudor](mailto:at@webhouse.dk) - Framework, Apps
	* [Christian Broberg](mailto:cb@webhouse.dk) (Phone: +45 22 68 08 80) - Lead Architect
	* [Henrik Hansen](mailto:hh@webhouse.dk) - API, Apps
	* [Mikkel Broberg](mailto:mb@webhouse.dk) - API, Apps

* Software Development:
    * [Frida Jakobsen](mailto:frida.jakobsen@hotmail.com) - Apps, CSS
	* [Elena-Luminia Gavrilovici](mailto:luminita.gavrilovici@yahoo.com) - Apps
    * [Kasper Nielsen](mailto:kasper8791@gmail.com) - Apps
    * [Anders Juel Lichon](mailto:Lichondk@gmail.com) - Apps
    * [Leonid Zorin](mailto:leonid9.021@gmail.com) - Apps

* Design & Marketing:
	* [Elena Frankovic](mailto:frankovic.elena@gmail.com) - Art Direction, Graphic design, Prototyping
    * [Tina Bota](mailto:bota.tina@gmail.com) - Art Direction, Design System, Prototyping
    * [Ineta Bulbenkovaite](mailto:i.bulbenkovaite@gmail.com) - Project Management, Communication, SoMe and Project Documentation (meta story)
	* [Mette Bugge](mailto:mette@webhouse.dk) - Project Facilitation, Mentoring, Sales, Backup
...
- Check out more articles in Slack
...
- "State" of the nation - how far are we with specific experiments and real-world code
...
## 4.3. GitHub Setup Instructions for experiments
After creating a new project with [create-project](https://github.com/cbroberg/create-project.git) it might be a good idea to create a GitHub repository for the experiment. This will help other developers easy access to your experiments. When you have a Github repository ready for the project (manually create the repository on GitHub) you can add the experiment project to the repository from the command line
...
## 5.3. Experiments List

### 5.3.1. Codesplitting / PRPL (codesplitting)
...
- experiments/footerlabel

### 5.3.5. Localization & Strings (internationalization and language support)
...
- We need a strong localization functionality that makes it easy to:
    ...
    - Translate strings from language to language which eventually should be available from its own app (ODEUM Localizer)
- [localize](https://github.com/cbroberg/localize)

### 5.3.6. Redux Forms (redux-form)
...
### 5.3.7. Datagrid/Datatables
- Experiment with datagrids, datatables and lists with large data payloads
...
- [Good looks](http://adazzle.github.io/react-data-grid/examples.html#/all-features)
- [React Rocks Examples](https://react.rocks/tag/DataTable)

### 5.3.8. React Drag and Drop (react-dnd)
...
- [Best practices with Draftjs](https://reactrocket.com/post/draft-js-best-practices/)
- [react-draft-wysiwyg](https://github.com/jpuri/react-draft-wysiwyg/)

### 5.3.11. Skeleton Loading
- Experiment with skeleton loading of pages and components
...
### 5.3.12. Color picker
- React Color picker module
- [react-color](https://github.com/casesandberg/react-color)

### 5.3.13. PDF Generator
- [react-pdf](https://github.com/diegomura/react-pdf)

### 5.3.14. GraphQL + Redux
...
### 5.3.15. Creating NPM packages containing our framework
...
#### 5.3.15.3. Single/Multiple components from multiple NPM packages
...
### 5.3.16. Demo App to Connect to the ODEUM Code framework
...
### 5.3.17. Full-screen presentations (ODEUM Sales Manager/ODEUM Report)
...
### 5.3.18. ODEUM Telemetry Services
...
### 5.3.20. REST and components API documentation platform/style
- Research and propose API documentation platform and style

### 5.3.21. REST API implementation experiments
...
### 5.3.22. IAM - Identity and Access Management
